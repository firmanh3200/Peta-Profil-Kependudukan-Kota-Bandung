...
with st.container(border=True):
    ...
    data = data.sort_values(by=['tahun', 'semester', 'jenis_pekerjaan'], ascending=[False, True, True])
    ...
    with kolom3:
        pilihanjenis = data[(data['tahun'] == tahunterpilih) & (data['semester'] == semterpilih)]['jenis_pekerjaan'].unique()
        jenisterpilih = st.selectbox("Filter Jenis Pekerjaan", pilihanjenis)
    ...
    if tahunterpilih and semterpilih and jenisterpilih:
        ...
        fig = px.choropleth_mapbox(
            data_frame=data[(data['tahun'] == tahunterpilih) & (data['semester'] == semterpilih) & (data['jenis_pekerjaan'] == jenisterpilih)],
            ...
            hover_data=['kemendagri_nama_kecamatan', 'kemendagri_nama_desa_kelurahan', 'tahun', 'semester', 'jenis_pekerjaan', 'jumlah_penduduk']
        )
